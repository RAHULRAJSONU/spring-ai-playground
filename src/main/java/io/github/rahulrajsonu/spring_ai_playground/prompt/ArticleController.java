package io.github.rahulrajsonu.spring_ai_playground.prompt;
...
public class ArticleController {
    ...
    @GetMapping("/post/new")
    public String newPost(@RequestParam(value = "topic", defaultValue = "Java in AI ecosystem.") String topic){
        var system = """
